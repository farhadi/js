...
(function(){
	this.Color = Class.extend({
		...
		toGrayscale: function() {
			var grayIntensity = Math.round(this.r * .3 + this.g * .59 + this.b * .11);
	...
	Color.prototype.toString = Color.prototype.toHex;
	
	// Parse strings looking for color tuples [255,255,255]
	// Code from jQuery Color Animations Plugin (http://plugins.jquery.com/project/color)
	...
	// From Interface by Stefan Petre (http://interface.eyecon.ro/)
	var colors = {
		aqua:[0,255,255],
		azure:[240,255,255],
		beige:[245,245,220],
